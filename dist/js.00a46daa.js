...
function exp() {
  //fonction qui englobera toutes les fonctions
  document.addEventListener('keydown', function (e) {
    // declaration de la fonction e avec l evenement 'keydown'
    var code = e.key; // declare la variable code qui prendra la valeur e.key (=...)

    var monAudio = document.getElementById(code); // declare la varible audios avec id code
    ...
    monAudio.addEventListener('ended', function (e) {
      // déclaration de la fonction avec l'événement 'ended' qui permet de mettre fin a la classe sound-active lorsque le son et terminer
